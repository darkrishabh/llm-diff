...
export function PromptDiffLogo({ size = 32 }: { size?: number }) {
  return (
    <svg
    ...
    >
      <defs>
        <linearGradient id="prompt-diff-logo-gradient" x1="4" y1="2" x2="28" y2="30" gradientUnits="userSpaceOnUse">
          <stop stopColor="#1e40af" />
          <stop offset="1" stopColor="#172554" />
        </linearGradient>
      </defs>
      <rect width="32" height="32" rx="8" fill="url(#prompt-diff-logo-gradient)" />
